...
* Follow [Firebase setup guide](https://firebase.google.com/docs/guides) and generate GoogleService-Info.plist for iOS and google-servce.json for android, and place those files in respective folder.
